...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StorageBucketSecret) DeepCopyInto(out *StorageBucketSecret) {
	*out = *in
	out.SecretKey = in.SecretKey
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StorageBucketSecret.
func (in *StorageBucketSecret) DeepCopy() *StorageBucketSecret {
	if in == nil {
		return nil
	}
	out := new(StorageBucketSecret)
	in.DeepCopyInto(out)
	return out
}
